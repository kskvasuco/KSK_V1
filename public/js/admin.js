document.addEventListener('DOMContentLoaded', () => {
    ...
    const productQuantityLimitInput = document.getElementById('productQuantityLimit');
    ...
    function setupEditForm(product) {
        ...
        if (productQuantityLimitInput) productQuantityLimitInput.value = product.quantityLimit || 0;
        ...
        productForm.addEventListener('submit', async (ev) => {
            ...
            const res = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    quantityLimit: productQuantityLimitInput ? (parseInt(productQuantityLimitInput.value) || 0) : 0,
