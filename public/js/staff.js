document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateStaffOrderCardHtml(order, isNested = false) { // Added isNested flag
        ...
        const adjustmentsContainerHtml = `
            ...
            <div style="text-align: right; margin-top: 10px; display: flex; justify-content: flex-end; gap: 12px; padding-right: 60px;">
                <button class="add-custom-item-btn" style="font-size: 14px; padding: 8px 16px; border: none; border-radius: 20px; background: #1a73e8; color: white; cursor: pointer; font-weight: 500; transition: background 0.2s;" onmouseover="this.style.background='#1557b0'" onmouseout="this.style.background='#104e9eff'">+ Add Charge</button>
            ...
            <div class="order-card-body" style="display: block;">
                ...
                <div class="profile-edit-form">
                    ...
                    <div style="margin-top: 10px; display: flex; gap: 10px;">
                        <button class="save-profile-btn">Update Profile</button>
                        <button class="cancel-profile-edit-btn" type="button" style="background-color: #6c757d;">Back</button>
                    </div>
    ...
    staffPanel.addEventListener('click', async (e) => {
        ...
        // Handle cancel-profile-edit-btn - go back to view profile
