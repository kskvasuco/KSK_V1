...
export default function StaffAdvancePayments() {
    ...
    const handleOrderClick = (status, orderId) => {
        let route = '/staff/pending';
        if (status === 'Rate Requested') route = '/staff/rate-requested';
        else if (status === 'Rate Approved') route = '/staff/rate-approved';
        else if (status === 'Confirmed') route = '/staff/confirmed';
        else if (status === 'Dispatch' || status === 'Partially Delivered') route = '/staff/dispatch';
        else if (status === 'Delivered') route = '/staff/delivered';
        else if (status === 'Paused') route = '/staff/paused';
        else if (status === 'Hold') route = '/staff/hold';
        else if (status === 'Cancelled') route = '/staff/cancelled';
